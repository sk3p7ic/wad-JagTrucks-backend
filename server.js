...
app.post("/api/signIn/truck/", (req, res) => {
  db.signIn(req.body.authName, req.body.password, "truck", res);
});

app.post("/api/signIn/student/", (req, res) => {
  db.signIn(req.body.authName, req.body.password, "student", res);
});
